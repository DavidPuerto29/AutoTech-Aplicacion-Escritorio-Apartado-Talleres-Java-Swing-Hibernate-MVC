...
Una vez que el empleado inicia sesión, podrá acceder a las **citas asignadas al taller** y actualizar su estado, como “En proceso”, “Finalizado” o “Cancelado”.
...
Por ejemplo, al pulsar un botón, el listener asociado invoca el controlador correspondiente, que procesa la lógica de la operación (inicio de sesión, registro, gestión de citas, etc.).
...
El proyecto demuestra **buenas prácticas y una estructura sólida**, aplicando el patrón **MVC**, persistencia con **Hibernate** y seguridad mediante **cifrado de contraseñas**.  

Aunque la interfaz en Swing no es el foco principal, la aplicación pone énfasis en **organización del código, mantenibilidad** y posibilidad de evolucionar hacia **interfaces más modernas** o **integración con APIs externas**.
