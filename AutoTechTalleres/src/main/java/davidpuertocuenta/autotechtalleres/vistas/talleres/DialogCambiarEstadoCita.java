...
public class DialogCambiarEstadoCita extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(modificarEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 290, 130));
        ...
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 320, 150));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogCambiarEstadoCita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogCambiarEstadoCita dialog = new DialogCambiarEstadoCita(new javax.swing.JFrame(), true);
